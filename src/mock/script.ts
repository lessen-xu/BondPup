...
export const script = {
  ...
  steps: {
    ...
    jars: {
      ...
      // 真实用户两次追问「未来罐是什么」——先说清它是什么,再问要不要留
      futureQuestion: "未来罐,放的是你暂时不打算花的钱。这个月想留一点吗?",
      futureDetail: "留下来的部分会从安心罐里出,留和不留都可以〜",
      futureOptions: ["这个月先不留", "我想留一点"],
      futureSummary: "未来罐 ▢▢▢ 元 · 安心罐会变成 ▢▢▢ 元",
      linkedSummary: "{jar} ▢▢▢ 元 · 安心罐会变成 ▢▢▢ 元",
      comfortLow: "这样安心罐就只剩 ▢▢▢ 元了，要不要少存一点？",
      reduceSaving: "少存一点",
      sourceQuestion: "安心罐已经归零了，这部分要从哪里来？",
      livingSource: "生活罐",
      livingSourceCost: "会影响这个月的房租吃饭",
      livingTooHigh: "这次收入已经都放进生活罐了，可以把这个数调低一点。",
      stepHint: "每个数字都可以再改。",
  ...
  home: {
    ...
    startEntry: "从零开始", demoEntry: "用合成示例体验", buyEntry: "帮我看看要不要买", moneyEntry: "记一笔钱", chatEntry: "有一笔钱想和你聊一聊",
