...
export function OnboardingFlow() {
  ...
  function jarAmount(kind: JarKind): number {
    if (!preview) return 0;
    if (kind === "comfort" && draft.screen === 9 && !comfortAccepted) return 0;
